...
### DkZ Prompt Archive - Generierung, Archivierung, CSV Import/Export, Status-Workflow, Vorlagen
...
![Lines](https://img.shields.io/badge/Lines-1529-ffb800?style=for-the-badge)
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-prompt-viewer.git

# Oeffnen
cd dkz-prompt-viewer
